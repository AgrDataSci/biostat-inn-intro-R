...
[CRAN task views](https://cran.r-project.org/web/views/) lists the most important R packages by topics.

---

# Geospatial analysis 

Some important spatial packages are rgeos, sf, sp, raster, terra, leaflet, gdistance, rgdal, maptools, and much more [here](https://cran.r-project.org/web/views/Spatial.html).

<center>
<img src="img/vegetables-in-europe.png" width="50%"/>
<center/>

.footnote[
[1] [de Sousa and Solberg (2020)](https://doi.org/10.3390/agriculture10080340)]
...
Excellent to right scientific papers, books, slides, thesis and reports when you write text along with R code and equations. 

Some important packages are knitr and rmarkdown.

<center>
<img src="img/joss-chirps.png" width="50%"/>
<center/>
...
.pull-left[
<img src="img/inn-uni.png" width="30%"/>
]
...
<img src="https://img.icons8.com/ios-filled/50/000000/email-open.png" width = "10%">[kaue.desousa@inn.no](mailto:k.desousa@cgiar.org)
